...
# Model pusher with bentoml - problem with the package
# import os
# import sys
...
#             os.system(
#                 f"bentoml containerize {self.model_pusher_config.bentoml_service_name}:latest -t 679448834216.dkr.ecr.eu-south-1.amazonaws.com/{self.model_pusher_config.bentoml_ecr_image}:latest"
#             )
...
#             os.system(
#                 "aws ecr get-login-password --region eu-south-1 | docker login --username AWS --password-stdin 679448834216.dkr.ecr.eu-south-1.amazonaws.com"
#             )
...
#             os.system(
#                 f"docker push 679448834216.dkr.ecr.eu-south-1.amazonaws.com/{self.model_pusher_config.bentoml_ecr_image}:latest"
#             )
